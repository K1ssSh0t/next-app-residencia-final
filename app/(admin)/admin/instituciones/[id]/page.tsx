...
import { CircleDollarSign, PlusIcon, UserIcon, UsersIcon } from "lucide-react";
...
export default async function Page(props: { params: Params }) {
    ...
    const datosGenerales = await db.query.datosInstitucionales.findMany({
        ...
        orderBy: (datosInstitucionales, { desc }) => [
            desc(datosInstitucionales.anio),
        ],
    });
    ...
    return (
        <div>
                            ...
                            <div className="grid gap-2 text-sm">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-x-3 gap-y-1.5">
                                    ...
                                    <div>
                                        ...
                                        <p className="font-medium">
                                            {institucion.tipoInstituciones?.descripcion}
                                        </p>
                                    </div>
                                    {!institucion?.nivelEducativo && (
                                        <>
                                            <div>
                                                ...
                                                <p className="font-medium">
                                                    {institucion.tipoBachilleres?.descripcion}
                                                </p>
                                            </div>
                                            <div>
                                                <span>Modalidad:</span>
                                    ...
                                    {(institucion.nivelEducativo == true ||
                                        institucion.tipoBachilleres?.descripcion ==
                                        "Tecnologico") && (
                                            <div>
                                                <span className="text-muted-foreground">
                                                    { }{" "}
                                                    {institucion.nivelEducativo
                                                        ? "Número de Carreras, Postgrados y Doctorados:"
                                                        : "Formación Educativa:"}
                                                </span>
                                                <p className="font-medium">
                                                    {institucion.numeroCarreras}
                                                </p>
                                            </div>
                                        )}
                                    {institucion && (
                                        <CardFooter className="px-3 py-2">
                                            <Link
                                                href={`/admin/instituciones/${institucion.id}/edit`}
                                                className="ml-auto"
                                            >
                                                <Button size="sm">
                                                        ...
                                                        {dato?.categoriasGenerales?.descripcion ===
                                                            ...
                                                            <div className="text-center px-2">
                                                                ...
                                                                <p className="font-semibold text-sm text-blue-600">
                                                                    {Number(dato?.cantidadHombres).toFixed(2) ||
                                                                        "0.00"}
                                                                </p>
                                                            </div>
                                                        ) : (
                                                            <>
                                                                <div className="text-center px-2">
                                                                    ...
                                                                    <p className="font-semibold text-sm text-pink-600">
                                                                        {Number(dato?.cantidadMujeres).toFixed(0) ||
                                                                            "0"}
                                                                    </p>
                                                                </div>
                                                                <div className="text-center px-2">
                                                                    ...
                                                                    <p className="font-semibold text-sm text-blue-600">
                                                                        {Number(dato?.cantidadHombres).toFixed(0) ||
                                                                            "0"}
                                                                    </p>
                                                                </div>
                                                            </>
            ...
            <div className="text-center font-bold text-xl flex justify-center m-4">
                Cuestionarios
            </div>
            <div>
                {cuestionario ? (
