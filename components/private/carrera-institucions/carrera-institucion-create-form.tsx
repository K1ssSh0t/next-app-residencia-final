...
import {
  createCarreraInstitucion,
  CreateCarreraInstitucionState,
} from "@/actions/private/carrera-institucions/create-carrera-institucion";
    ...
    <div>
      <div className="mb-4 p-4 bg-yellow-100 border border-yellow-400 rounded">
        <p className="text-yellow-700">
          Los campos que son requeridos son marcados con un asterisco (*)
        </p>
      </div>
      <form
        action={dispatch}
      ...
      >
        ...
        <div className="flex flex-col gap-2">
          ...
          <GenericCombobox
            ...
            keywordFields={["id", "descripcion"]}
            template={(item) => (
              <div aria-required id="modalidadesId">
                {item.descripcion}
              </div>
            )}
          />
